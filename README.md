...
The target of this fork is to integrate IMU data into structure from motion process to help reconstruction of large scene in completeness and robustness.
