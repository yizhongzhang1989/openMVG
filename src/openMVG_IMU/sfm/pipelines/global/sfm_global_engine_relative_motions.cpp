...
GlobalSfMReconstructionEngine_RelativeMotions_General::GlobalSfMReconstructionEngine_RelativeMotions_General(
  ...
  : ReconstructionEngine(sfm_data, soutDirectory), sLogging_file_(sloggingFile)
{
  ...
  if (!sLogging_file_.empty())
  {
    ...
    html_doc_stream_->pushInfo(
      htmlDocument::htmlMarkup("h1", std::string("GlobalSfMReconstructionEngine_RelativeMotions_General")));
...
void GlobalSfMReconstructionEngine_RelativeMotions_General::SetFeaturesProvider(Features_Provider * provider)
{
  features_provider_ = provider;
}

void GlobalSfMReconstructionEngine_RelativeMotions_General::SetMatchesProvider(Matches_Provider * provider)
{
  matches_provider_ = provider;
}

void GlobalSfMReconstructionEngine_RelativeMotions_General::SetRotationAveragingMethod
(
...
void GlobalSfMReconstructionEngine_RelativeMotions_General::SetTranslationAveragingMethod
(
...
bool GlobalSfMReconstructionEngine_RelativeMotions_General::Process() {
...
bool GlobalSfMReconstructionEngine_RelativeMotions_General::Compute_Global_Rotations
(
...
bool GlobalSfMReconstructionEngine_RelativeMotions_General::Compute_Global_Translations
(
...
bool GlobalSfMReconstructionEngine_RelativeMotions_General::Compute_Initial_Structure
(
  matching::PairWiseMatches & tripletWise_matches
)
{
...
bool GlobalSfMReconstructionEngine_RelativeMotions_General::Adjust()
{
...
void GlobalSfMReconstructionEngine_RelativeMotions_General::Compute_Relative_Rotations
(
