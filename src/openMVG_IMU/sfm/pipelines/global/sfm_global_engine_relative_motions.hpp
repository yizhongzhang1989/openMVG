...
#ifndef OPENMVG_IMU_SFM_GLOBAL_ENGINE_RELATIVE_MOTIONS_HPP
#define OPENMVG_IMU_SFM_GLOBAL_ENGINE_RELATIVE_MOTIONS_HPP
...
class GlobalSfMReconstructionEngine_RelativeMotions_General : public ReconstructionEngine
{
public:

  GlobalSfMReconstructionEngine_RelativeMotions_General(
    const SfM_Data & sfm_data,
    const std::string & soutDirectory,
    const std::string & loggingFile = "");

  ~GlobalSfMReconstructionEngine_RelativeMotions_General() override;
