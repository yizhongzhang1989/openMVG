...
#ifndef OPENMVG_SFM_LOCALIZATION_SEQUENTIAL_SFM_GENERAL_HPP
#define OPENMVG_SFM_LOCALIZATION_SEQUENTIAL_SFM_GENERAL_HPP
...
public:
  ...
  SequentialSfMReconstructionEngine_General(
    const SfM_Data & sfm_data,
    const std::string & soutDirectory,
    const std::string & loggingFile = "");

  ~SequentialSfMReconstructionEngine_General() override;
