...
bool PoseQuaternLocalParameterization::Plus(const double *x, const double *delta, double *x_plus_delta) const
{
...
bool PoseQuaternLocalParameterization::ComputeJacobian(const double *x, double *jacobian) const
{
