...
//                    if(  sfm_data.Speeds.at(pose_j->first).al_opti && sfm_data.Speeds.at(pose_i->first).al_opti ) continue;
                    ...
                    norm_eror += (imu_error.norm() - avg_residual) * (imu_error.norm() - avg_residual);
                }
            }
            ...
            file << "sum_imu_error = " << sum_imu_error << " num = " << imu_error_num << std::endl;
            ...
            std::cout << "sum_imu_error = " << sum_imu_error << " num = " << imu_error_num << std::endl;
            file << "norm_eror = " << norm_eror << std::endl;
            std::cout << "--------------------------------------------------" << std::endl;
                                                                  ...
                                                                  const double* ex_paparm)
        {
            ...
            for (auto & structure_landmark_it : sfm_data.structure)
            {
                ...
                for (const auto & obs_it : obs)
                {
                    ...
                    auto residual = GetProjectionError( &map_poses.at(view->id_pose)[0],
                                                        ...
                                                        structure_landmark_it.second.X.data(),
                                                        ob_i);
                    norm_eror += (residual.norm() - avg_residual) * (residual.norm() - avg_residual);
                }
            }
            ...
            file << "sum_residual = " << sum_residual << " num = " << projection_num << std::endl;
            file << "norm_eror = " << norm_eror << std::endl;
            file << "--------------------------------------------------" << std::endl;
            file.close();

            std::cout << "------------------ PROJECTION SUM-----------------" << std::endl;
            std::cout << "sum_residual = " << sum_residual << " num = " << projection_num << std::endl;
            file << "norm_eror = " << norm_eror << std::endl;
            std::cout << "--------------------------------------------------" << std::endl;
